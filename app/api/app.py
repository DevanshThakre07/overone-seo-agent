...
def create_app() -> FastAPI:
    ...
    application = FastAPI(
        ...
        description=(
            ...
            "Alerts: GET /alerts/status, POST /alerts/test. "
    ...
    def root() -> RedirectResponse:
        """Avoid bare-host 404 — send browsers to the dashboard UI."""
    ...
    application.include_router(keyword_plan.router)
...
def run() -> None:
    """CLI entry: seo-api — respects PORT for hosted platforms (Railway/Render/Fly)."""
    import os

    port = int(os.environ.get("PORT", "8000"))
    host = os.environ.get("SEO_BIND_HOST", "0.0.0.0")
